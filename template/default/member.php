...
<p class="copyright">贴吧签到助手 <?php echo VERSION; ?> - Designed by <a href="http://www.ikk.me" target="_blank">kookxiang</a>. <?php echo date('Y',time()); ?> &copy; 搭建在：<a href="http://lab.liujiantao.me" target="_blank">TT's Laboratory</a> - <a href="http://www.liujiantao.me/suibi/archives/281.html" target="_blank">赞助开发</a><?php if(getSetting('beian_no')) echo ' - <a href="http://www.miibeian.gov.cn/" target="_blank" rel="nofollow">'.getSetting('beian_no').'</a>'; ?></p>
